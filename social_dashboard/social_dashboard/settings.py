...
SECRET_KEY = 'django-insecure-_!g$y=fj7rspd+&11r+!%)1@u=2w=$3f4_urhn^)%6_yo#2&b!'
...
# Optional: configure login redirection after authentication
...
REACT_BUILD_DIR = os.path.join(BASE_DIR, 'social-dashboard-frontend/build')

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            BASE_DIR / 'templates',  # This should be set to the 'templates' directory in your project
        ],
        'APP_DIRS': True,  # Set this to True to allow looking in app directories (e.g., social_dashboard/templates)
        'OPTIONS': {
            'context_processors': [
                'django.template.context_processors.debug',
                'django.template.context_processors.request',
